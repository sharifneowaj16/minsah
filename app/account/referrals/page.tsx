...
const mockReferralData = {
  referralCode: 'MINSAH2024',
  referralLink: 'https://minsahbeauty.cloud/referral/MINSAH2024',
  totalReferrals: 8,
...
const mockReferrals: Referral[] = [
  { id: '1', referralCode: 'MINSAH2024', referredEmail: 'sarah.johnson@email.com', referredName: 'Sarah Johnson', status: 'completed', rewardPoints: 1500, createdAt: new Date('2024-01-10'), completedAt: new Date('2024-01-15') },
  { id: '2', referralCode: 'MINSAH2024', referredEmail: 'mike.wilson@email.com', referredName: 'Mike Wilson', status: 'made_purchase', rewardPoints: 1500, createdAt: new Date('2024-01-08'), completedAt: new Date('2024-01-12') },
  { id: '3', referralCode: 'MINSAH2024', referredEmail: 'emma.brown@email.com', referredName: 'Emma Brown', status: 'made_purchase', rewardPoints: 1000, createdAt: new Date('2024-01-05'), completedAt: new Date('2024-01-10') },
  { id: '4', referralCode: 'MINSAH2024', referredEmail: 'david.lee@email.com', referredName: 'David Lee', status: 'signed_up', rewardPoints: 500, createdAt: new Date('2024-01-03') },
  { id: '5', referralCode: 'MINSAH2024', referredEmail: 'lisa.anderson@email.com', referredName: 'Lisa Anderson', status: 'pending', rewardPoints: 0, createdAt: new Date('2023-12-28') },
];
